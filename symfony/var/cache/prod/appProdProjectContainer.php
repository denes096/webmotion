...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('b3ndcdIOsH', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jWB0dTGPDJ', 0, 'wPdHJZhiW6RF7EaRUaxKJU', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WqTywDXSNp', 0, 'wPdHJZhiW6RF7EaRUaxKJU', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'webmotion_mysql', 'port' => NULL, 'dbname' => 'webmotion', 'user' => 'webmotion', 'password' => 'webmotion', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0PXHbI0iXh', 0, 'wPdHJZhiW6RF7EaRUaxKJU', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('6164afb0c703f1.11056162')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'webmotion_mysql',
            'database_port' => NULL,
            'database_name' => 'webmotion',
            'database_user' => 'webmotion',
            'database_password' => 'webmotion',
            ...
            'validator.mapping.cache.prefix' => 'validator_72ff1adcf48f7110f6aa6b04488464c90d10156e0c9b95c59cfa06dfa3a255e4',
